...
select f.nome, f.ano, f.id_genero, g.nome 
from filme as f
inner join genero as g
on g.idgenero= f.id_genero;

/*contagem de Estilos dos filmes */
select  g.nome, count(g.nome)
from filme as f
inner join genero as g
on g.idgenero= f.id_genero
group by g.nome;

select nome, count(nome) from filme
group by nome;
...
select * from rel_loca;
/* COLOCO EM UMA PASTA PUBLICA*/

COPY REL_LOCA TO
'C:\Users\Public\Arquivo\REL_POST'
DELIMITER ';'
CSV HEADER; /* ELE É UM CSV E TEM CABEÇALHO*/
